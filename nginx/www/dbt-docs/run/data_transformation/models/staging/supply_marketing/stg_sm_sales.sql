  ...
  create view "dwh"."staging"."stg_sm_sales__dbt_tmp"
...
with src as (
    ...
    from "dwh"."raw"."raw_sales"
),

known_products as (
    select product_id from "dwh"."staging"."stg_sm_products"
),

known_customers as (
    select customer_id from "dwh"."staging"."stg_sm_customers"
),
